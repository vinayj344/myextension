...
import org.myextension.constants.MyextensionConstants;



/**
 * This is the extension manager of the Myextension extension.
 */
public class MyextensionManager extends GeneratedMyextensionManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MyextensionManager.class.getName());
	 ...
	 */
	public static MyextensionManager getInstance()
	{
		return (MyextensionManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MyextensionConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MyextensionManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MyextensionManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MyextensionManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MyextensionManager called, current tenant: " + getTenant().getTenantID());
		}
	}
