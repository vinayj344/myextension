...
/**
 * This is the extension manager of the Myextensionfacade extension.
 */
public class MyextensionfacadeManager extends GeneratedMyextensionfacadeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MyextensionfacadeManager.class.getName());
	 ...
	 */
	public static MyextensionfacadeManager getInstance()
	{
		return (MyextensionfacadeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MyextensionfacadeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MyextensionfacadeManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MyextensionfacadeManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MyextensionfacadeManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MyextensionfacadeManager called, current tenant: " + getTenant().getTenantID());
		}
	}
