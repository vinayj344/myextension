...
/**
 * This is the extension manager of the Myextensioncore extension.
 */
public class MyextensioncoreManager extends GeneratedMyextensioncoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MyextensioncoreManager.class.getName());
	 ...
	 */
	public static MyextensioncoreManager getInstance()
	{
		return (MyextensioncoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				MyextensioncoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MyextensioncoreManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MyextensioncoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of MyextensioncoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of MyextensioncoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
